...
func (book *engine.OrderBook) Process(order Order) []engine.Trade {
...
func (book *engine.OrderBook) processLimitBuyOrder(order Order) []Trade {
...
func (book *engine.OrderBook) processLimitSellOrder(order Order) []Trade {
